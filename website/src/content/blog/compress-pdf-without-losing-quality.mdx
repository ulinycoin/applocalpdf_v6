...
[LocalPDF's compression tool](/features/compress-pdf) uses intelligent algorithms to:
...
[Try it now →](/features/compress-pdf)
...
### Merging
- [Combine multiple PDFs](/features/merge-pdf)
- Reduce file count
- Simplify management
...
Ready to compress your PDFs? Open [Compress PDF](/features/compress-pdf) when the file is ready but still too heavy for the next send, upload, or archive step.

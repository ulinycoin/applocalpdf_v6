...
[LocalPDF's Merge PDF workflow](/features/merge-pdf) makes combining PDFs simple and secure:
...
Large PDF files can slow down the merging process. Consider [compressing PDFs](/features/compress-pdf) before merging if they are particularly large.
...
If your PDFs contain sensitive information, review [PDF security best practices](/blog/pdf-security-best-practices) before sharing the merged output.

## Common Questions About Merging PDFs

### Can I merge password-protected PDFs?

Some protected documents need to be prepared first before they can be merged. Keep access-control requirements in mind before changing document security.
...
Ready to merge your PDFs? Try [LocalPDF's Merge PDF workflow](/features/merge-pdf) for a faster and more private path from source files to one output.

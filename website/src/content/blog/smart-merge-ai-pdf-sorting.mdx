...
2. **Ensure text is selectable** - For scanned PDFs, run [OCR PDF](/features/ocr-pdf) first
...
Ready to try it? Open [Merge PDF](/features/merge-pdf) and upload your files. Smart Merge activates automatically.

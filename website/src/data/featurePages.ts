...
export const featurePages: FeaturePageData[] = [
  ...
  {
    slug: 'merge-pdf',
    title: 'Merge PDF files by dragging pages into place',
    metaTitle: 'Merge PDF Files with Drag and Drop | LocalPDF',
  ...
  },
  {
    ...
    metaDescription: 'Turn scanned PDFs into searchable, copyable documents. OCR runs locally in your browser — no upload, no waiting on a server, no file leaves your device.',
  ...
  },
  {
    ...
    metaDescription: 'Reduce PDF file size without losing quality. Compression runs in your browser — no upload required, works on scans and image-heavy documents.',
  ...
  {
    slug: 'split-pdf',
    title: 'Split PDF files by pulling out the pages you need',
    metaTitle: 'Split PDF Files with Drag and Drop Control | LocalPDF',

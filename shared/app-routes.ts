...
const LEGACY_TARGET_ROUTE_MAP: Record<string, string> = {
  ...
  merge: APP_STUDIO_ROUTE,
  'merge-pdf': APP_STUDIO_ROUTE,
  ...
  compress: APP_STUDIO_ROUTE,
  'compress-pdf': APP_STUDIO_ROUTE,
  ocr: APP_STUDIO_ROUTE,
  'ocr-pdf': APP_STUDIO_ROUTE,
  tables: APP_STUDIO_CONVERT_ROUTE,
  'tables-pdf': APP_STUDIO_CONVERT_ROUTE,
  'convert-pdf': APP_STUDIO_ROUTE,
  'auto-toc-pdf': APP_STUDIO_ROUTE,
